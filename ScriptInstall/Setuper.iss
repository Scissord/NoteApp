...
#define MyAppURL "https://github.com/Scissord/NoteApp"
...
AppId={{AF9B0C67-09C0-4CE3-AA5A-041CE16349FF}
AppName={#MyAppName}
...
Source: "..\src\NoteApp.View\bin\Debug\NoteApp.exe"; DestDir: "{app}"; Flags: ignoreversion
